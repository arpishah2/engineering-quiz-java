...
public class Instagram {
	...
	public List<Integer> getMediaFeed(int userId) {
		...
		//Note: We can also use heap to store objects with timestamp and mediaId than comparing against array;ist of media in this case
	...
	public void unfollow(int followerId, int followedId) {
		if(!users.contains(followerId) || !users.contains(followedId))
			return;
		if(!follow.containsKey(followerId))
